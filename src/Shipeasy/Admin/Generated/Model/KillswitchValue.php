...
/**
 * KillswitchValue Class Doc Comment
 *
 * @category Class
 ...
 */
class KillswitchValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KillswitchValue';
     ...
     * Sets value
     *
     * @param bool $value Default boolean delivered when no `switches` entry matches.
     *
     * @return self
     */
     ...
     * Sets switches
     *
     * @param array<string,bool>|null $switches Per-switch overrides; a matching key takes precedence over `value`.
     *
     * @return self
     */
