...
/**
 * PublishI18nProfileRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PublishI18nProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PublishI18nProfileRequest';
     ...
     * Sets chunk
     *
     * @param string|null $chunk Optional chunk label to stamp on the audit log. Publishing is profile-wide regardless — the whole profile is snapshotted into one KV blob.
     *
     * @return self
     */
