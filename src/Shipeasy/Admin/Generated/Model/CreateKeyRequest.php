 ...
 *
 * @category Class
 * @description Body for &#x60;POST /api/admin/keys&#x60;. Only &#x60;type&#x60; is required.  &#x60;env&#x60; is **required** for &#x60;server&#x60; and &#x60;client&#x60; keys (the key is bound to one environment — that binding is the read-env isolation boundary). For &#x60;admin&#x60; and &#x60;ops&#x60; keys &#x60;env&#x60; is ignored and the key is pinned to &#x60;prod&#x60;.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CreateKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SCOPES_EXPERIMENTS_READ = 'experiments:read';
    public const SCOPES_GATES_EVALUATE = 'gates:evaluate';
    ...
    {
        return [
            self::SCOPES_EXPERIMENTS_READ,
            self::SCOPES_GATES_EVALUATE,
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && (mb_strlen($this->container['name']) > 160)) {
            $invalidProperties[] = "invalid value for 'name', the character length must be smaller than or equal to 160.";
        }
        ...
        if (!is_null($this->container['expires_in_days']) && ($this->container['expires_in_days'] > 3650)) {
            $invalidProperties[] = "invalid value for 'expires_in_days', must be smaller than or equal to 3650.";
        }
     ...
     * Sets type
     *
     * @param string $type Key kind to mint. `server` (back-end), `client` (public, browser), `admin` (CLI/devtools token), `ops` (restricted unattended-trigger credential). `admin`/`ops` keys don't count toward the plan key limit.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 160)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateKeyRequest., must be smaller than or equal to 160.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateKeyRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $expires_in_days Days until the key expires (1–3650), or `null`/omitted for a key that never expires. Ignored for `admin` keys (fixed 90-day expiry) and `ops` keys (short sliding window).
     *
     * @return self
     */
    public function setExpiresInDays($expires_in_days)
    {
        ...
        if (!is_null($expires_in_days) && ($expires_in_days > 3650)) {
            throw new \InvalidArgumentException('invalid value for $expires_in_days when calling CreateKeyRequest., must be smaller than or equal to 3650.');
        }
        if (!is_null($expires_in_days) && ($expires_in_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $expires_in_days when calling CreateKeyRequest., must be bigger than or equal to 1.');
        }
