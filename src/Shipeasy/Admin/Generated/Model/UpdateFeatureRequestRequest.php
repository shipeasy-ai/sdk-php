...
/**
 * UpdateFeatureRequestRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateFeatureRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateFeatureRequestRequest';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 200)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UpdateFeatureRequestRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UpdateFeatureRequestRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\S(.*\\S)?$/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling UpdateFeatureRequestRequest., must conform to the pattern /^\\S(.*\\S)?$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateFeatureRequestRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setUseCase($use_case)
    {
        ...
        if ((mb_strlen($use_case) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $use_case when calling UpdateFeatureRequestRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setGithubPrNumber($github_pr_number)
    {
        ...
        if (!is_null($github_pr_number) && ($github_pr_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $github_pr_number when calling UpdateFeatureRequestRequest., must be bigger than or equal to 1.');
        }
