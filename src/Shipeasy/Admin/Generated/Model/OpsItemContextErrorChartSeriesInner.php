 ...
 *
 * @category Class
 * @description One occurrence bucket.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OpsItemContextErrorChartSeriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets t
     *
     * @param float $t Bucket start — unix epoch **milliseconds**. Bucket width scales with the window (hourly up to ~5 days, coarser beyond).
     *
     * @return self
     */
