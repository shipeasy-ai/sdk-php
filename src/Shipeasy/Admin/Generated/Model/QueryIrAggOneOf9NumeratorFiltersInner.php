...
/**
 * QueryIrAggOneOf9NumeratorFiltersInner Class Doc Comment
 *
 * @category Class
 ...
 */
class QueryIrAggOneOf9NumeratorFiltersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'QueryIr_agg_oneOf_9_numerator_filters_inner';
    ...
    public function setLabel($label)
    {
        ...
        if ((!preg_match("/^[a-z_][a-z0-9_]{0,63}$/", ObjectSerializer::toString($label)))) {
            throw new \InvalidArgumentException("invalid value for \$label when calling QueryIrAggOneOf9NumeratorFiltersInner., must conform to the pattern /^[a-z_][a-z0-9_]{0,63}$/.");
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 512)) {
            throw new \InvalidArgumentException('invalid length for $value when calling QueryIrAggOneOf9NumeratorFiltersInner., must be smaller than or equal to 512.');
        }
