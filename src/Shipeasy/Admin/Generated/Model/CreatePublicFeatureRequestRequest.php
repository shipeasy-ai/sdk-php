 ...
 */
class CreatePublicFeatureRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreatePublicFeatureRequestRequest';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 200)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreatePublicFeatureRequestRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreatePublicFeatureRequestRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\S(.*\\S)?$/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling CreatePublicFeatureRequestRequest., must conform to the pattern /^\\S(.*\\S)?$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePublicFeatureRequestRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setUseCase($use_case)
    {
        ...
        if ((mb_strlen($use_case) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $use_case when calling CreatePublicFeatureRequestRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setUserAgent($user_agent)
    {
        ...
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 500)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling CreatePublicFeatureRequestRequest., must be smaller than or equal to 500.');
        }
