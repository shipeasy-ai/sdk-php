...
/**
 * UpdateConfigSchemaRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateConfigSchemaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateConfigSchemaRequest';
     ...
     * Sets schema
     *
     * @param array<string,mixed> $schema Replacement JSON Schema (draft 2020-12). Validated against every published value before it lands.
     *
     * @return self
     */
