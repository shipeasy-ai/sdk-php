...
/**
 * ExperimentReadoutCaveat Class Doc Comment
 *
 * @category Class
 ...
 */
class ExperimentReadoutCaveat implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExperimentReadoutCaveat';
     ...
     * Sets id
     *
     * @param string $id Stable caveat id.
     *
     * @return self
     */
     ...
     * Sets severity
     *
     * @param string $severity Caveat severity as rendered in the results view.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text Human-readable caveat text.
     *
     * @return self
     */
     ...
     * Sets acknowledged
     *
     * @param bool $acknowledged Whether the caller ticked this caveat when minting (decision-gating acknowledgment).
     *
     * @return self
     */
