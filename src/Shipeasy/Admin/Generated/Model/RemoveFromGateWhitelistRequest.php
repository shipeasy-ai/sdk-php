...
/**
 * RemoveFromGateWhitelistRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class RemoveFromGateWhitelistRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RemoveFromGateWhitelistRequest';
     ...
     * Sets entries
     *
     * @param string[] $entries Identities to stop admitting. Entries that aren't listed are skipped, so the call is idempotent.
     *
     * @return self
     */
    public function setEntries($entries)
    {
        ...
        if ((count($entries) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entries when calling RemoveFromGateWhitelistRequest., number of items must be greater than or equal to 1.');
        }
