...
/**
 * SetGateWhitelistRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SetGateWhitelistRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetGateWhitelistRequest';
     ...
     * Sets attr
     *
     * @param \Shipeasy\Admin\Generated\Model\GateWhitelistAttr|null $attr Identity attribute to match on. Defaults to the whitelist's current attribute, or `email` when the gate has no whitelist yet.
     *
     * @return self
     */
     ...
     * Sets entries
     *
     * @param string[] $entries The complete whitelist after the call. Pass `[]` to remove the whitelist from the gate entirely.
     *
     * @return self
     */
