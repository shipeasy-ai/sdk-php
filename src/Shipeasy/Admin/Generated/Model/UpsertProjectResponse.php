...
/**
 * UpsertProjectResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsertProjectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpsertProjectResponse';
     ...
     * Sets name
     *
     * @param string $name Project name (the supplied `name`, or the domain on first create).
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param bool $created `true` if this call created the project, `false` if it returned an existing one.
     *
     * @return self
     */
