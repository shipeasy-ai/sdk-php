...
/**
 * CreateGateTemplateResponse Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class CreateGateTemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateGateTemplateResponse';
     ...
     * Sets id
     *
     * @param string $id Newly assigned template id (`gtpl_…`).
     *
     * @return self
     */
