...
/**
 * ExperimentApiRowExposureInner Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentApiRowExposureInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExperimentApiRow_exposure_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ds'] === null && !$this->isNullableSetToNull('ds')) {
            $invalidProperties[] = "'ds' is required";
        }
     ...
     * Sets ds
     *
     * @param string|null $ds Optional gate name (a `targeting`-type flag). Only callers that pass the gate are enrolled in the experiment.
     *
     * @return self
     */
    ...
    {
        if (is_null($ds)) {
            array_push($this->openAPINullablesSetToNull, 'ds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ds', $nullablesSetToNull);
            if ($index !== FALSE) {
