...
/**
 * ApproveEventResponse Class Doc Comment
 *
 * @category Class
 * @description Result of updating or approving an event.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ApproveEventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApproveEventResponse';
     ...
     * Sets id
     *
     * @param string $id Event id that was updated.
     *
     * @return self
     */
