...
/**
 * CreateOAuthConnectorRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOAuthConnectorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateOAuthConnectorRequest';
     ...
     * Sets provider
     *
     * @param string $provider OAuth/app connector destination.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOAuthConnectorRequest., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOAuthConnectorRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets events
     *
     * @param \Shipeasy\Admin\Generated\Model\ConnectorEvent[] $events Events to subscribe to. At least one is required.
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling CreateOAuthConnectorRequest., number of items must be greater than or equal to 1.');
        }
