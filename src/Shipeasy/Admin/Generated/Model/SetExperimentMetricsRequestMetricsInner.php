...
/**
 * SetExperimentMetricsRequestMetricsInner Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class SetExperimentMetricsRequestMetricsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetExperimentMetricsRequest_metrics_inner';
     ...
     * Sets metric_id
     *
     * @param string $metric_id Existing metric id in the project.
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string $role Metric role. `goal` drives the decision, `guardrail` blocks ship if degraded, `secondary` is informational.
     *
     * @return self
     */
