...
/**
 * RevokeKeyResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RevokeKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RevokeKeyResponse';
    ...
    public const REVOKED_TRUE = 'true';
     ...
     * @return string[]
     */
    public function getRevokedAllowableValues()
    {
        return [
            self::REVOKED_TRUE,
        ];
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getRevokedAllowableValues();
        if (!is_null($this->container['revoked']) && !in_array($this->container['revoked'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'revoked', must be one of '%s'",
                $this->container['revoked'],
     ...
     * Sets id
     *
     * @param string $id Id of the key that was revoked.
     *
     * @return self
     */
    ...
    public function setRevoked($revoked)
    {
        ...
        $allowedValues = $this->getRevokedAllowableValues();
        if (!in_array($revoked, $allowedValues, true)) {
