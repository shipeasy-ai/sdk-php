...
/**
 * UpdateI18nKeyRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateI18nKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateI18nKeyRequest';
     ...
     * Sets value
     *
     * @param string $value New value for the key (the only overwrite path).
     *
     * @return self
     */
