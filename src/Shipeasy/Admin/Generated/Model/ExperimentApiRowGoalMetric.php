...
/**
 * ExperimentApiRowGoalMetric Class Doc Comment
 *
 * @category Class
 ...
 */
class ExperimentApiRowGoalMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExperimentApiRow_goalMetric';
     ...
     * Sets name
     *
     * @param string|null $name Optional gate name (a `targeting`-type flag). Only callers that pass the gate are enrolled in the experiment.
     *
     * @return self
     */
