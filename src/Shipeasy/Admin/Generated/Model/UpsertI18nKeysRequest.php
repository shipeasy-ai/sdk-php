...
/**
 * UpsertI18nKeysRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsertI18nKeysRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpsertI18nKeysRequest';
     ...
     * Sets profile_id
     *
     * @param string $profile_id Target profile id to upsert keys into.
     *
     * @return self
     */
     ...
     * Sets chunk
     *
     * @param string|null $chunk Logical grouping the keys are filed under. Defaults to `default`.
     *
     * @return self
     */
    public function setChunk($chunk)
    {
        ...
        if ((mb_strlen($chunk) > 64)) {
            throw new \InvalidArgumentException('invalid length for $chunk when calling UpsertI18nKeysRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($chunk) < 1)) {
            throw new \InvalidArgumentException('invalid length for $chunk when calling UpsertI18nKeysRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets keys
     *
     * @param \Shipeasy\Admin\Generated\Model\UpsertI18nKeysRequestKeysInner[] $keys Keys to upsert. Existing keys ARE overwritten — this is the bulk overwrite path.
     *
     * @return self
     */
    public function setKeys($keys)
    {
        ...
        if ((count($keys) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $keys when calling UpsertI18nKeysRequest., number of items must be less than or equal to 5000.');
        }
        if ((count($keys) < 1)) {
            throw new \InvalidArgumentException('invalid length for $keys when calling UpsertI18nKeysRequest., number of items must be greater than or equal to 1.');
        }
