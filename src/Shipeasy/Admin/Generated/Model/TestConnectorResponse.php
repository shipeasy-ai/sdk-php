 ...
 */
class TestConnectorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TestConnectorResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['issue_url'] === null && !$this->isNullableSetToNull('issue_url')) {
            $invalidProperties[] = "'issue_url' is required";
        }
    ...
    public function setIssueUrl($issue_url)
    {
        if (is_null($issue_url)) {
            array_push($this->openAPINullablesSetToNull, 'issue_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issue_url', $nullablesSetToNull);
            if ($index !== FALSE) {
