...
/**
 * QueryIrGroupBy Class Doc Comment
 *
 * @category Class
 * @description How the series is split. On the envelope rather than in &#x60;expr&#x60; because every leaf of one expression shares it.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class QueryIrGroupBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'QueryIr_groupBy';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['labels']) > 8)) {
            $invalidProperties[] = "invalid value for 'labels', number of items must be less than or equal to 8.";
        }
     ...
     * Sets op
     *
     * @param string $op `by` names the output dimensions; `without` names the ones to drop.
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param string[] $labels Labels the grouping names.
     *
     * @return self
     */
    public function setLabels($labels)
    {
        ...
        if ((count($labels) > 8)) {
            throw new \InvalidArgumentException('invalid value for $labels when calling QueryIrGroupBy., number of items must be less than or equal to 8.');
        }
