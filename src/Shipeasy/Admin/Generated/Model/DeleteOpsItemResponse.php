...
/**
 * DeleteOpsItemResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteOpsItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeleteOpsItemResponse';
     ...
     * Sets ok
     *
     * @param bool $ok Always `true` — the item (and its comments, attachments, tags, and investigation records) was deleted.
     *
     * @return self
     */
