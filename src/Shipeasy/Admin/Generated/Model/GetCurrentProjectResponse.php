...
class GetCurrentProjectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['error_autoclose_days'] === null) {
            $invalidProperties[] = "'error_autoclose_days' can't be null";
        }
        if ($this->container['error_ticket_min_occurrences'] === null) {
            $invalidProperties[] = "'error_ticket_min_occurrences' can't be null";
        }
     ...
     *
     * @param int $error_autoclose_days Days an `open` tracked error may go unseen before the nightly sweep auto-resolves it. `0` disables auto-close for this project. Ingest reopens a resolved error the moment it recurs, so this never hides a live issue.
     *
     * @return self
     */
     ...
     *
     * @param int $error_ticket_min_occurrences Occurrence count a tracked error must cross before an `error` ticket is auto-filed into the ops queue. Customising it requires a paid plan; unentitled projects always run at the platform default of 10.
     *
     * @return self
     */
