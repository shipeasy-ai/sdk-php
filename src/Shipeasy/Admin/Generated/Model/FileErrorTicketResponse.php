...
/**
 * FileErrorTicketResponse Class Doc Comment
 *
 * @category Class
 * @description The feedback ticket that tracks this error. Idempotent — if an open &#x60;error&#x60; ticket already tracks this fingerprint (hand- or auto-filed), the existing one is returned instead of creating a duplicate.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FileErrorTicketResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FileErrorTicketResponse';
     ...
     * Sets id
     *
     * @param string $id Feedback ticket id.
     *
     * @return self
     */
