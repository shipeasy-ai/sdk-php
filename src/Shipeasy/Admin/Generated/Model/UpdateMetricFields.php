...
/**
 * UpdateMetricFields Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateMetricFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateMetricFields';
    ...
    public function setFolder($folder)
    {
        ...
        if (!is_null($folder) && (mb_strlen($folder) > 256)) {
            throw new \InvalidArgumentException('invalid length for $folder when calling UpdateMetricFields., must be smaller than or equal to 256.');
        }
        if (!is_null($folder) && (!preg_match("/^[a-zA-Z0-9_-]+$/", ObjectSerializer::toString($folder)))) {
            throw new \InvalidArgumentException("invalid value for \$folder when calling UpdateMetricFields., must conform to the pattern /^[a-zA-Z0-9_-]+$/.");
        }
    ...
    public function setEventName($event_name)
    {
        ...
        if ((mb_strlen($event_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $event_name when calling UpdateMetricFields., must be bigger than or equal to 1.');
        }
    ...
    public function setWinsorizePct($winsorize_pct)
    {
        ...
        if (($winsorize_pct > 99)) {
            throw new \InvalidArgumentException('invalid value for $winsorize_pct when calling UpdateMetricFields., must be smaller than or equal to 99.');
        }
        if (($winsorize_pct < 1)) {
            throw new \InvalidArgumentException('invalid value for $winsorize_pct when calling UpdateMetricFields., must be bigger than or equal to 1.');
        }
