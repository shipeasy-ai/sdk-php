...
/**
 * ListConfigVersionsResponseInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ListConfigVersionsResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListConfigVersionsResponse_inner';
     ...
     * Sets version
     *
     * @param int $version Published version number on the requested env (monotonically increasing per env).
     *
     * @return self
     */
    public function setVersion($version)
    {
        ...
        if (($version > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $version when calling ListConfigVersionsResponseInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling ListConfigVersionsResponseInner., must be bigger than or equal to 1.');
        }
