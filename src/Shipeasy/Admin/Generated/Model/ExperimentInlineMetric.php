...
class ExperimentInlineMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets aggregation
     *
     * @param string|null $aggregation Reducer for the `event` form. Defaults to `count_events`. `count_users` was removed: Analytics Engine samples rows and weights the survivors, and a distinct count cannot be reweighted, so it under-reports by the sample interval. `retention_7d` / `retention_30d` were removed on 2026-08-10: the day count reached no query and no reducer, so both produced the same number as a distinct user count and reported it as a returning-user rate.
     *
     * @return self
     */
