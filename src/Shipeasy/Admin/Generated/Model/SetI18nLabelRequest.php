...
/**
 * SetI18nLabelRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SetI18nLabelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetI18nLabelRequest';
     ...
     * Sets key
     *
     * @param string $key Dotted key path to set, e.g. `home.cta`.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value New value for the key. Inserted when the key is new, overwritten when it exists.
     *
     * @return self
     */
     ...
     * Sets profile
     *
     * @param string|null $profile Profile name to target, e.g. `en:prod`. Omit to target the project's default-marked profile.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Optional human note to store with the key.
     *
     * @return self
     */
