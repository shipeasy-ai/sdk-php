...
/**
 * ListGatesResponseDataInnerRulesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ListGatesResponseDataInnerRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListGatesResponse_data_inner_rules_inner';
    ...
    public function setAttr($attr)
    {
        ...
        if ((mb_strlen($attr) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attr when calling ListGatesResponseDataInnerRulesInner., must be bigger than or equal to 1.');
        }
