 ...
 *
 * @category Class
 * @description Generic success acknowledgement for operations with no meaningful payload.
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets ok
     *
     * @param bool $ok Always `true` — the operation succeeded (errors use the error envelope instead).
     *
     * @return self
     */
