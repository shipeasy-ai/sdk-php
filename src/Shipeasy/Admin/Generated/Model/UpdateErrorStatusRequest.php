...
/**
 * UpdateErrorStatusRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateErrorStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateErrorStatusRequest';
     ...
     * Sets status
     *
     * @param string $status New triage state. `resolved` reopens automatically on recurrence; `ignored` is sticky.
     *
     * @return self
     */
