 ...
 */
class CreatePublicTicketResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreatePublicTicketResponse';
     ...
     * Sets id
     *
     * @param string|null $id The new item's id. Absent on a deduped response — nothing was created, so there is no new id to report.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Per-project item number. On a deduped response this is the number of the OPEN ticket already tracking the report, which is what a caller should show the user either way.
     *
     * @return self
     */
    ...
    {
        return $this->container['deduped'];
    }

    /**
     * Sets deduped
     *
     * @param bool|null $deduped `true` when an open ticket already tracked this report and nothing was filed (HTTP 200). Absent on a fresh file (HTTP 201).
     *
     * @return self
     */
