...
/**
 * GateTemplateRule Class Doc Comment
 *
 * @category Class
 ...
 */
class GateTemplateRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GateTemplateRule';
    ...
    protected static $openAPITypes = [
        'attr' => 'string',
        'op' => 'string',
        'value' => '\Shipeasy\Admin\Generated\Model\GateTemplateRuleValue'
    ];
     ...
     * Sets op
     *
     * @param string $op Comparison operator. Equality: `eq`/`neq`. Set membership: `in`/`not_in` (value is an array). Numeric order: `gt`/`gte`/`lt`/`lte`. Semver order: `semver_gt`/`semver_gte`/`semver_lt`/`semver_lte`. String: `contains` (substring), `regex` (JS-flavour pattern). Cross-resource: `gate_pass` (value is another gate's name), `exp_in` (attr is an experiment name, value is a variant / `\"$holdout\"` / `\"$any\"`).
     *
     * @return self
     */
     ...
     * Gets value
     *
     * @return \Shipeasy\Admin\Generated\Model\GateTemplateRuleValue
     */
     ...
     * Sets value
     *
     * @param \Shipeasy\Admin\Generated\Model\GateTemplateRuleValue $value value
     *
     * @return self
     */
