...
/**
 * CreateMetricWithQueryIr Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateMetricWithQueryIr implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateMetricWithQueryIr';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateMetricWithQueryIr., must be smaller than or equal to 128.');
        }
        if ((!preg_match("/^[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?(?:\\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)?$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CreateMetricWithQueryIr., must conform to the pattern /^[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?(?:\\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)?$/.");
        }
    ...
    public function setFolder($folder)
    {
        ...
        if (!is_null($folder) && (mb_strlen($folder) > 256)) {
            throw new \InvalidArgumentException('invalid length for $folder when calling CreateMetricWithQueryIr., must be smaller than or equal to 256.');
        }
        if (!is_null($folder) && (!preg_match("/^[a-zA-Z0-9_-]+$/", ObjectSerializer::toString($folder)))) {
            throw new \InvalidArgumentException("invalid value for \$folder when calling CreateMetricWithQueryIr., must conform to the pattern /^[a-zA-Z0-9_-]+$/.");
        }
    ...
    public function setEventName($event_name)
    {
        ...
        if ((mb_strlen($event_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $event_name when calling CreateMetricWithQueryIr., must be bigger than or equal to 1.');
        }
    ...
    public function setWinsorizePct($winsorize_pct)
    {
        ...
        if (($winsorize_pct > 99)) {
            throw new \InvalidArgumentException('invalid value for $winsorize_pct when calling CreateMetricWithQueryIr., must be smaller than or equal to 99.');
        }
        if (($winsorize_pct < 1)) {
            throw new \InvalidArgumentException('invalid value for $winsorize_pct when calling CreateMetricWithQueryIr., must be bigger than or equal to 1.');
        }
