...
/**
 * GateWhitelist Class Doc Comment
 *
 * @category Class
 ...
 */
class GateWhitelist implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GateWhitelist';
     ...
     * Sets id
     *
     * @param string $id Resolved gate id.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The gate's stable `name`.
     *
     * @return self
     */
     ...
     * Gets attr
     *
     * @return \Shipeasy\Admin\Generated\Model\GateWhitelistAttr
     */
     ...
     * Sets attr
     *
     * @param \Shipeasy\Admin\Generated\Model\GateWhitelistAttr $attr attr
     *
     * @return self
     */
     ...
     * Sets entries
     *
     * @param string[] $entries The whitelisted identities, in the order they are stored. Deduplicated case-sensitively; an empty array means the gate has no whitelist.
     *
     * @return self
     */
