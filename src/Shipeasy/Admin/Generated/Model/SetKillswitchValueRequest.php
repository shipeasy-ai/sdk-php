...
/**
 * SetKillswitchValueRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SetKillswitchValueRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetKillswitchValueRequest';
     ...
     * Sets value
     *
     * @param bool $value Flat boolean to publish on `env`. Publishes a new version on that env only.
     *
     * @return self
     */
