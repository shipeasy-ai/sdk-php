...
/**
 * UpsertProjectRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsertProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpsertProjectRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['domain']) > 2048)) {
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling UpsertProjectRequest., must be smaller than or equal to 2048.');
        }
     ...
     * Sets name
     *
     * @param string|null $name Human-readable project name. Defaults to the domain on first create.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsertProjectRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsertProjectRequest., must be bigger than or equal to 1.');
        }
