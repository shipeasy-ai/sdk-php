...
/**
 * GetExperimentResultsResponseExperiment Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class GetExperimentResultsResponseExperiment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetExperimentResultsResponse_experiment';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetExperimentResultsResponseExperiment., must be smaller than or equal to 128.');
        }
        if ((!preg_match("/^[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?(?:\\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)?$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling GetExperimentResultsResponseExperiment., must conform to the pattern /^[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?(?:\\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)?$/.");
        }
