...
/**
 * ListKeysResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ListKeysResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Shipeasy\Admin\Generated\Model\KeyRecord[]',
        'next_cursor' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Shipeasy\Admin\Generated\Model\KeyRecord[]
     */
     ...
     * Sets data
     *
     * @param \Shipeasy\Admin\Generated\Model\KeyRecord[] $data data
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Opaque cursor for the next page, or `null` on the last page. Pass it back as the `cursor` query parameter.
     *
     * @return self
     */
