...
/**
 * ErrorSeriesResponseRowsInner Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ErrorSeriesResponseRowsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ErrorSeriesResponse_rows_inner';
     ...
     * Sets v
     *
     * @param float $v Occurrence count in the bucket (sample-interval weighted).
     *
     * @return self
     */
