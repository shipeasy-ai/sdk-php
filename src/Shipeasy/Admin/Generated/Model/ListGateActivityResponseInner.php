...
/**
 * ListGateActivityResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Shipeasy\Admin\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ListGateActivityResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ListGateActivityResponse_inner';
     ...
     * Sets action
     *
     * @param string $action Audit action (e.g. `gate.create`, `gate.update`, `gate.enable`, `gate.disable`, `gate.delete`).
     *
     * @return self
     */
     ...
     * Sets actor_email
     *
     * @param string|null $actor_email Optional gate name (a `targeting`-type flag). Only callers that pass the gate are enrolled in the experiment.
     *
     * @return self
     */
