...
/**
 * GetMetricSeriesResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class GetMetricSeriesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetMetricSeriesResponse';
     ...
     * Sets sql
     *
     * @param string $sql The Analytics Engine SQL executed to produce `rows` (echoed for transparency / debugging).
     *
     * @return self
     */
     ...
     * Sets rows
     *
     * @param \Shipeasy\Admin\Generated\Model\GetMetricSeriesResponseRowsInner[] $rows Bucketed series, ordered by `t` ascending. For a metric with a `groupBy` clause each bucket has one row per label combination, with the label values as extra string/number properties on the row.
     *
     * @return self
     */
