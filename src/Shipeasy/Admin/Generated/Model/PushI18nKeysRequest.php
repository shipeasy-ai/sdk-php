...
/**
 * PushI18nKeysRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PushI18nKeysRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PushI18nKeysRequest';
     ...
     * Sets profile_id
     *
     * @param string $profile_id Target profile id to add keys to.
     *
     * @return self
     */
     ...
     * Sets keys
     *
     * @param \Shipeasy\Admin\Generated\Model\UpsertI18nKeysRequestKeysInner[] $keys Keys to add. Insert-only by default — existing keys are reported back as `skipped` (set `force` to overwrite them instead).
     *
     * @return self
     */
     ...
     * Sets force
     *
     * @param bool|null $force Overwrite keys that already exist with the submitted value instead of skipping them. Overwritten keys come back as `updated`. Off by default so a routine push can never clobber live translations.
     *
     * @return self
     */
