 ...
 */
class CreatePublicBugRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreatePublicBugRequest';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 200)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreatePublicBugRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreatePublicBugRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\S(.*\\S)?$/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling CreatePublicBugRequest., must conform to the pattern /^\\S(.*\\S)?$/.");
        }
    ...
    public function setStepsToReproduce($steps_to_reproduce)
    {
        ...
        if ((mb_strlen($steps_to_reproduce) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $steps_to_reproduce when calling CreatePublicBugRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setActualResult($actual_result)
    {
        ...
        if ((mb_strlen($actual_result) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $actual_result when calling CreatePublicBugRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setExpectedResult($expected_result)
    {
        ...
        if ((mb_strlen($expected_result) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $expected_result when calling CreatePublicBugRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setUserAgent($user_agent)
    {
        ...
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 500)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling CreatePublicBugRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setViewport($viewport)
    {
        ...
        if (!is_null($viewport) && (mb_strlen($viewport) > 40)) {
            throw new \InvalidArgumentException('invalid length for $viewport when calling CreatePublicBugRequest., must be smaller than or equal to 40.');
        }
